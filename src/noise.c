...
#define NUM_GRADIENTS (sizeof(gradients3D) / sizeof(int))
...
*/
static const uint8_t PERM_DEFAULT[] = {
...
static inline double extrapolate(int xsb, int ysb, int zsb, double dx, double dy, double dz) {
