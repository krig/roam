...
static const char* chunk_vshader = "#version 130\n"
	...
	"out float out_depth;\n"
	"void main() {\n"
	"    vec3 pos = chunk_offset.xyz + position.xyz * (32.0/0.969696969696969697);\n"
//	"    pos = round(pos);\n"
	"    out_color = color;\n"
	"    out_depth = length((modelview * vec4(pos.xyz, 1)).xyz);\n"
	"    out_normal = normalmat * normal.xyz;\n"
	"    out_texcoord = texcoord;\n"
...
//	"    vec3 light = clamp(out_color.xyz + (out_color.w * intensity), 0.0, 1.0);\n"
	"    vec3 light = vec3(intensity);\n"
//	"    base = base * (light.xyz + amb_color.xyz * (1 - intensity));\n"
